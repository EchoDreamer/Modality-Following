...
## The causal attention results by varying the ratio of original test data.
...
## The results removing the binary distribution constraint in Eq. 6 to quantify the results of the attention mask.
...
## The results of causal attention analysis for InternVL3-14B
